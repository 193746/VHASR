...
def prepare_data(args, distributed_option):
    ...
    if args.dataset_type == "small":
        ...
        args.test_shape_file = [os.path.join(args.data_dir, args.test_set, "{}_shape".format(data_names[0]))]
        args.train_data_path_and_name_and_type, args.valid_data_path_and_name_and_type = [], []
        args.test_data_path_and_name_and_type = []
        for file_name, data_name, data_type in zip(file_names, data_names, data_types):
            ...
            args.test_data_path_and_name_and_type.append(
                ["{}/{}/{}".format(args.data_dir, args.test_set, file_name), data_name, data_type])
        ...
        args.test_data_file = os.path.join(args.data_dir, args.test_set, "{}_data.list".format(concat_data_name))
