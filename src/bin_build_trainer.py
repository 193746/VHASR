...
import build_trainer as build_trainer_modelscope
...
def build_trainer(modelscope_dict,
    ...
    args = build_args(args, parser, [])
    # args = build_args(args, parser, extra_task_params)

    args.bias_decoder_conf={}
    args.vh_conf={}
    ...
    train_dataloader, valid_dataloader,test_dataloader = build_dataloader(args)

    # Trainer, including model, optimizers, etc.
    trainer = build_trainer_modelscope.build_trainer(
        args=args,
        model=model,
